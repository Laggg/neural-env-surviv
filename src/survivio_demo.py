...
def demo_app():
    ...
    # press any key to update states
    if is_it_windows:
        cv2.imshow('Press wasd to update state', first_show)
    else:
        cv2.imshow('Press any key to update states', first_show)
    ...
    while True:
        ...
        if is_it_windows:
            if keyboard.is_pressed('e'):
                ...
                if is_it_windows:
                    cv2.imshow('Press wasd to update state', game_img)
                else:
                    cv2.imshow('Press any key to update states!', game_img)
                cv2.waitKey(3500)
                exit()
