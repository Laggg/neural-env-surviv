...
*This repo is support for [a global project](https://github.com/Laggg/ml-bots-surviv.io) - to create a smart ML bot for a browser-based multiplayer online battle royale game [surviv.io](https://surviv.io/) which would be interesting to watch*  
